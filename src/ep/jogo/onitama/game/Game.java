...
public interface Game {
  ...
  /**
   * Método que imprime o tabuleiro no seu estado atual OBS: Esse método é opcional não será
   * utilizado na correção, mas serve para acompanhar os resultados parciais do jogo
   */
  void printBoard();
}
